...
#     print(model_embedding.get_weights())
    ...
    model_f2.add(Conv1D(300, 2, padding='same', activation='relu'))
    model_f2.add(MaxPooling1D(2))
    model_f2.add(Conv1D(300, 2, padding='same', activation='relu'))
    model_f2.add(MaxPooling1D(2))
    model_f2.add(Conv1D(300, 2, padding='same', activation='relu'))
    model_f2.add(MaxPooling1D(26))
    model_f2.add(Flatten())

    merged = Merge([model_left, model_right,model_cent,model_f2], mode='concat')
